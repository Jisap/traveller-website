...
const About = () => {
  ...
  return (
    <PageTransition>
      ...
      <div className="px-[2%] ms:px-[8%] lg:px-[12%] py-[8%]  flex justify-between items-start xl:flex-row flex-col gap-12 h-auto xl:h-250 bg-yellow-light overflow-hidden">
        <div className="about-image w-full xl:w-[50%] relative flex justify-center items-center h-full">
          ...
          <img src={aboutimg} alt="aboutimg" className="w-auto z-1" />
        </div>
      ...
      >
        ...
        <div className="left-hot-ballon">
          <img src={ballonLeft} alt="ballonleft" />
        </div>

        <div className="right-hot-ballon">
          <img src={ballonRight} alt="ballonright" />
        </div>
      </div>
    </PageTransition>
  )
